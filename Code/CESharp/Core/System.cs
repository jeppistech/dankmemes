...
namespace CryEngine
{
	...
	public class LevelSystem : ILevelSystemListener
	{
		...
		public static void Instantiate()
		{
			...
			Global.gEnv.pGame.GetIGameFramework ().GetILevelSystem ().AddListener (_instance);
		}
		...
		public static void Destroy()
		{
			if (_instance != null) 
			{
				if(Global.gEnv != null && Global.gEnv.pGame != null && Global.gEnv.pGame.GetIGameFramework() != null)
					Global.gEnv.pGame.GetIGameFramework ().GetILevelSystem ().RemoveListener (_instance);
				_instance.Dispose ();
				_instance = null;
			}
		}
	...
	public class GameFramework : IGameFrameworkListener
	{
		...
		public static void Instantiate()
		{
			...
			Global.gEnv.pGame.GetIGameFramework ().RegisterListener (_instance, "MonoGameFramework", EFRAMEWORKLISTENERPRIORITY.FRAMEWORKLISTENERPRIORITY_DEFAULT);
		...
		public static void Destroy()
		{
			...
			{
				if(Global.gEnv != null && Global.gEnv.pGame != null && Global.gEnv.pGame.GetIGameFramework() != null)
					Global.gEnv.pGame.GetIGameFramework().UnregisterListener(_instance);
				_instance.Dispose();
				_instance = null;
			}
		}
	...
	public class Mouse : IHardwareMouseEventListener, IGameUpdateReceiver
	{
		...
		static IMouseOverride s_override = null;
		static float _lmx = 0;
		static float _lmy = 0;
		static bool _updateLeftDown = false;
		static bool _updateLeftUp = false;
		...
		private static int s_hitEntityId = 0;
		public static int HitEntityId ///< ID of IEntity under cursor position.
		{
		...
		void HitScenes(int x, int y)
		{
			...
			HitEntityId = Env.Renderer.RayToUV (Camera.Current.Position, mouseDir, ref u, ref v);
			HitEntityUV.x = u;
			HitEntityUV.y = v;
		}
